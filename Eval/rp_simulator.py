...
ACC_HDR  = {"x-api-key": "/zWgZdpBePIBiBbxVftRw6HjIyMFFb/u1tkpYqzxUiY=", "Content-Type": "application/json"}
VG_HDR   = {"x-api-key": "/zWgZdpBePIBiBbxVftRw6HjIyMFFb/u1tkpYqzxUiY=", "Content-Type": "application/json"}
