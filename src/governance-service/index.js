...
app.post('/proposals/:id/approve', async (req, res, next) => {
    ...
    try {
        ...
        if (!isVerified) return res.status(401).json({ error: 'Bad Sig' });
...
const server = app.listen(3000, async () => {
    ...
    console.log('Governance Service on 3000');
});
